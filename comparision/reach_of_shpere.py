...
V0, F0 = gpy.icosphere(2) # Not used
# Reconstruct triangle mesh
# Vr,Fr = gpy.reach_for_the_spheres(U, None, V0, F0, S=S, verbose=False)
Vr, Fr = gpy.reach_for_the_spheres(U, None, V_mc, F_mc, S=S, verbose=False)

gpy.write_mesh("reach_for_the_spheres.ply", Vr, Fr)
