import numpy as np
from lie_geometry import lie_inner_product, circle_to_lie, lie_to_circle, plane_to_lie
from lie_geometry import line_quadric_intersection as line_quadric_intersection, line_quadric_intersection_single
...
class LieCone:
    ...
    def __init__(self, G, N_extra=None, filter_type=0, n_check_planes=10, cut_bbx_factor=-1., timeit=False, verbose=False, rot_around_xdp2=False, filter_results=False, assertions=False, full_simplices_only=True, atol=1e-8):
        ...
        try:
            ...
            print("!!! Convex Hull failed with Q12, retrying with QJ !!!")
            self.ch = ConvexHull(Np, qhull_options='QJ')
